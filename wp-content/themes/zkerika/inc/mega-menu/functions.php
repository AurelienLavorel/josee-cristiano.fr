...
if( ! class_exists( 'EF3MegaMenuFramework' ) ) {
	...
	class EF3MegaMenuFramework {
		...
		function __construct() {
			...
			if(!isset($zkerika_theme_options['zkerika_enable_mega_menu']) || !$zkerika_theme_options['zkerika_enable_mega_menu'])
				return;
...
add_action('init', 'zkerika_mega_menu', 5);

function zkerika_mega_menu(){
